...
/**
 * create time: 2018/5/29  11:20
 * create author: Hition
 * descriptions: 视频播放更多设置（亮度、声音、快进播放倍数）
 */
public class MoreSettingPanel extends FrameLayout implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        mAudioSeek = findViewById(R.id.seekBar_audio);
        mLightSeek = findViewById(R.id.seekBar_light);

        mBtnSpeed1 = findViewById(R.id.btn_speed1);
        mBtnSpeed125 =  findViewById(R.id.btn_speed125);
        mBtnSpeed15 =  findViewById(R.id.btn_speed15);
        mBtnSpeed2 =  findViewById(R.id.btn_speed2);
