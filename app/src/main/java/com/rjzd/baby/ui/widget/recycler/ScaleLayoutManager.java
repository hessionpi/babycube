...
public class ScaleLayoutManager extends ViewPagerLayoutManager {
    ...
    public ScaleLayoutManager(Context context, int itemSpace,float minAlpha) {
        this(new Builder(context, itemSpace).setMinAlpha(minAlpha));
    }
  /*  public ScaleLayoutManager(Context context, int itemSpace, int orientation) {
    ...
    public static class Builder {
        private static final float SCALE_RATE = 0.6f;
