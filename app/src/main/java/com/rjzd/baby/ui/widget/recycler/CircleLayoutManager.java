package com.rjzd.baby.ui.widget.recycler;
...
public class CircleLayoutManager extends ViewPagerLayoutManager {
    ...
    public CircleLayoutManager(Context context,int radius, int gravity,int angleInterval, boolean reverseLayout) {
        this(new Builder(context).setRadius(radius).setGravity(gravity).setAngleInterval(angleInterval).setReverseLayout(reverseLayout));
    }
