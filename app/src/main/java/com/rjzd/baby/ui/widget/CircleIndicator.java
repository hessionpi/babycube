...
/**
 * create time: 2018/6/29  11:30
 * create author: Hition
 * descriptions: 用来过渡小圆点，在引导页或者需要轮播的banner图中用到
 */
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorUnselectedBackgroundResId = R.drawable.shape_circle_pregnancy_week;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorBackgroundResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable, R.drawable.shape_circle);
    ...
    /*public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.anim.scale_with_alpha, 0, R.drawable.shape_circle, R.drawable.shape_circle);
    }
*/
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin,
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.shape_circle
