...
import com.rjzd.baby.model.player.Video;
...
//        mResolutionTxt.setVisibility(INVISIBLE);
    ...
    public void setPlayProgressTxt(int nowSecond, int allSecond) {
        mTimeTxt1.setText(ZDUtils.formattedTime(nowSecond / 1000));
        mTimeTxt2.setText(ZDUtils.formattedTime(allSecond / 1000));
    }
