package com.rjzd.baby.ui.widget.wheel;
...
/**
 * create time: 2018/6/6  11:12
 * create author: Hition
 * descriptions: 自定义滚轮效果
 */
...
public class WheelView extends ScrollView {
    ...
    private void init(Context context) {
        ...
        Logger.d("parent: " + this.getParent());
    ...
    private TextView createView(String item) {
        ...
        if (0 == itemHeight) {
            ...
            Logger.d("itemHeight: " + itemHeight);
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (viewWidth == 0) {
            viewWidth = DensityUtil.getScreenWidth(context);
